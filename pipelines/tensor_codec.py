...
class TensorCodec:
    ...
    def __init__(self, compression_pipeline):
        """Initialize."""
        logger.debug(f'** in function: TensorCodec:__init__')
    ...
    def set_lossless_pipeline(self, lossless_pipeline):
        ...
        logger.debug(f'** in function: TensorCodec:set_lossless_pipeline')
    ...
    def compress(self, tensor_key, data, require_lossless=False, **kwargs):
        ...
        """
        logger.debug(f'** in function: TensorCodec:compress')
        if require_lossless:
    ...
    def decompress(self, tensor_key, data, transformer_metadata,
        ...
        """
        logger.debug(f'** in function: TensorCodec:decompress')
        tensor_name, origin, round_number, report, tags = tensor_key
    ...
    def generate_delta(tensor_key, nparray, base_model_nparray):
        ...
        """
        logger.debug(f'** in function: TensorCodec:generate_delta')
        tensor_name, origin, round_number, report, tags = tensor_key
    ...
    def apply_delta(tensor_key, delta, base_model_nparray, creates_model=False):
        ...
        """
        logger.debug(f'** in function: TensorCodec:apply_delta')
        tensor_name, origin, round_number, report, tags = tensor_key
    ...
    def find_dependencies(self, tensor_key, send_model_deltas):
        ...
        logger.debug(f'** in function: TensorCodec:find_dependencies')
