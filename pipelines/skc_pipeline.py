...
class KmeansTransformer(Transformer):
    ...
    def __init__(self, n_cluster=6):
        """Initialize."""
        logger.debug(f'** in function: KmeansTransformer:__init__')
    ...
    def forward(self, data, **kwargs):
        ...
        Returns:
            ...
            metadata: dictionary to store a list of meta information.
        """
        logger.debug(f'** in function: KmeansTransformer:forward')
        # clustering
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        """
        logger.debug(f'** in function: KmeansTransformer:backward')
    ...
    def _float_to_int(np_array):
        ...
        """
        logger.debug(f'** in function: KmeansTransformer:_float_to_int')
...
class SKCPipeline(TransformationPipeline):
    ...
    def __init__(self, p_sparsity=0.1, n_clusters=6, **kwargs):
        ...
        """
        logger.debug(f'** in function: SKCPipeline:__init__')
