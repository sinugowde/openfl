...
class Transformer:
    ...
    def forward(self, data, **kwargs):
        ...
        Returns:
            ...
            metadata
        """
        logger.debug(f'** in function: Transformer:forward')
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        Returns:
            transformed_data
        """
        logger.debug(f'** in function: Transformer:backward')
        raise NotImplementedError
...
class Float32NumpyArrayToBytes(Transformer):
    ...
    def __init__(self):
        """Initialize."""
        logger.debug(f'** in function: Float32NumpyArrayToBytes:__init__')
        self.lossy = False
    ...
    def forward(self, data, **kwargs):
        ...
        Returns:
            ...
            metadata:
        """
        logger.debug(f'** in function: Float32NumpyArrayToBytes:forward')
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        logger.debug(f'** in function: Float32NumpyArrayToBytes:backward')
...
class TransformationPipeline:
    ...
    def __init__(self, transformers, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional parameters to pass to the function
        """
        logger.debug(f'** in function: TransformationPipeline:__init__')
    ...
    def forward(self, data, **kwargs):
        ...
        """
        logger.debug(f'** in function: TransformationPipeline:forward')
        transformer_metadata = []
    ...
    def backward(self, data, transformer_metadata, **kwargs):
        ...
        """
        logger.debug(f'** in function: TransformationPipeline:backward')
    ...
    def is_lossy(self):
        ...
        logger.debug(f'** in function: TransformationPipeline:is_lossy')
