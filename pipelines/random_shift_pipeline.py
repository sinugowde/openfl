...
class RandomShiftTransformer(Transformer):
    ...
    def __init__(self):
        """Initialize."""
        logger.debug(f'** in function: RandomShiftTransformer:__init__')
        self.lossy = False
    ...
    def forward(self, data, **kwargs):
        ...
        """
        logger.debug(f'** in function: RandomShiftTransformer:forward')
        shape = data.shape
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        Returns:
            transformed_data:
        """
        logger.debug(f'** in function: RandomShiftTransformer:backward')
...
class RandomShiftPipeline(TransformationPipeline):
    ...
    def __init__(self, **kwargs):
        """Initialize."""
        logger.debug(f'** in function: RandomShiftPipeline:__init__')
