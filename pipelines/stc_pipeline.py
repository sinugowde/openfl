...
class SparsityTransformer(Transformer):
    ...
    def __init__(self, p=0.01):
        ...
        """
        logger.debug(f'** in function: SparsityTransformer:__init__')
        self.lossy = True
        self.p = p
    ...
    def forward(self, data, **kwargs):
        ...
        """
        logger.debug(f'** in function: SparsityTransformer:forward')
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        """
        logger.debug(f'** in function: SparsityTransformer:backward')
        data = data.astype(np.float32)
    ...
    def _topk_func(x, k):
        ...
        """
        logger.debug(f'** in function: SparsityTransformer:_topk_func')
...
class TernaryTransformer(Transformer):
    ...
    def __init__(self):
        """Initialize."""
        logger.debug(f'** in function: TernaryTransformer:__init__')
        self.lossy = True
    ...
    def forward(self, data, **kwargs):
        ...
        Returns:
            ...
            metadata: dictionary to store a list of meta information.
        """
        logger.debug(f'** in function: TernaryTransformer:forward')
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        """
        logger.debug(f'** in function: TernaryTransformer:backward')
        # TODO
        import copy
    ...
    def _float_to_int(np_array):
        ...
        """
        logger.debug(f'** in function: TernaryTransformer:_float_to_int')
...
class GZIPTransformer(Transformer):
    ...
    def __init__(self):
        """Initialize."""
        logger.debug(f'** in function: GZIPTransformer:__init__')
        self.lossy = False
    ...
    def forward(self, data, **kwargs):
        ...
        """
        logger.debug(f'** in function: GZIPTransformer:forward')
    ...
    def backward(self, data, metadata, **kwargs):
        ...
        Returns:
            data:
        """
        logger.debug(f'** in function: GZIPTransformer:backward')
...
class STCPipeline(TransformationPipeline):
    ...
    def __init__(self, p_sparsity=0.1, n_clusters=6, **kwargs):
        ...
        """
        logger.debug(f'** in function: STCPipeline:__init__')
