...
class FLExperiment:
    ...
    def __init__(
        ...
        setup_logging()
        self.logger.debug(f'** in function: FLExperiment:__init__')

    def _assert_experiment_accepted(self):
        """Assure experiment is sent to director."""
        self.logger.debug(f'** in function: FLExperiment:_assert_experiment_accepted')
    ...
    def get_best_model(self):
        ...
        self.logger.debug(f'** in function: FLExperiment:get_best_model')
    ...
    def get_last_model(self):
        ...
        self.logger.debug(f'** in function: FLExperiment:get_last_model')
        self._assert_experiment_accepted()
    ...
    def _rebuild_model(self, tensor_dict, upcoming_model_status=ModelStatus.BEST):
        ...
        self.logger.debug(f'** in function: FLExperiment:_rebuild_model')
    ...
    def stream_metrics(self, tensorboard_logs: bool = True) -> None:
        """Stream metrics."""
        self.logger.debug(f'** in function: FLExperiment:stream_metrics')
        self._assert_experiment_accepted()
    ...
    def write_tensorboard_metric(self, metric: dict) -> None:
        ...
        self.logger.debug(f'** in function: FLExperiment:write_tensorboard_metric')
    ...
    def remove_experiment_data(self):
        ...
        self.logger.debug(f'** in function: FLExperiment:remove_experiment_data')
        self._assert_experiment_accepted()
    ...
    def prepare_workspace_distribution(self, model_provider, task_keeper, data_loader,
        ...
        self.logger.debug(f'** in function: FLExperiment:prepare_workspace_distribution')
    ...
    def start(self, *, model_provider, task_keeper, data_loader,
        ...
        """
        self.logger.debug(f'** in function: FLExperiment:start')
    ...
    def define_task_assigner(self, task_keeper, rounds_to_train):
        ...
        self.logger.debug(f'** in function: FLExperiment:define_task_assigner')
    ...
    def restore_experiment_state(self, model_provider):
        ...
        self.logger.debug(f'** in function: FLExperiment:restore_experiment_state')
    ...
    def _pack_the_workspace():
        ...
        logger1.debug(f'** in function: FLExperiment:_pack_the_workspace')
    ...
    def remove_workspace_archive(self):
        ...
        self.logger.debug(f'** in function: FLExperiment:remove_workspace_archive')
        os.remove(self.arch_path)
        del self.arch_path

    def _get_initial_tensor_dict(self, model_provider):
        """Extract initial weights from the model."""
        self.logger.debug(f'** in function: FLExperiment:_get_initial_tensor_dict')
        self.task_runner_stub = self.plan.get_core_task_runner(model_provider=model_provider)
    ...
    def _prepare_plan(self, model_provider, data_loader,
        ...
        self.logger.debug(f'** in function: FLExperiment:_prepare_plan')
    ...
    def _serialize_interface_objects(
        ...
        self.logger.debug(f'** in function: FLExperiment:_serialize_interface_objects')
...
class TaskKeeper:
    ...
    def __init__(self) -> None:
        ...
        logger1.debug(f'** in function: TaskKeeper:__init__')
    ...
    def add_kwargs(self, **task_kwargs):
        ...
        """
        logger1.debug(f'** in function: TaskKeeper:add_kwargs')
        # The highest level wrapper for allowing arguments for the decorator
        def decorator_with_args(training_method):
            logger1.debug(f'** in function: TaskKeeper:decorator_with_args')
    ...
    def set_aggregation_function(self, aggregation_function: AggregationFunction):
        ...
        """
        logger1.debug(f'** in function: TaskKeeper:set_aggregation_function')
        def decorator_with_args(training_method):
            logger1.debug(f'** in function: TaskKeeper:decorator_with_args')
    ...
    def get_registered_tasks(self) -> Dict[str, Task]:
        ...
        logger1.debug(f'** in function: TaskKeeper:get_registered_tasks')
        return self._tasks
...
class ModelInterface:
    ...
    def __init__(self, model, optimizer, framework_plugin) -> None:
        ...
        """
        logger1.debug(f'** in function: ModelInterface:__init__')
        self.model = model
    ...
    def provide_model(self):
        """Retrieve model."""
        logger1.debug(f'** in function: ModelInterface:provide_model')
        return self.model

    def provide_optimizer(self):
        """Retrieve optimizer."""
        logger1.debug(f'** in function: ModelInterface:provide_optimizer')
...
class DataInterface:
    ...
    def __init__(self, **kwargs):
        ...
        self.kwargs = kwargs
        logger1.debug(f'** in function: DataInterface:__init__')

    @property
    def shard_descriptor(self):
        """Return shard descriptor."""
        logger1.debug(f'** in function: DataInterface:shard_descriptor')
    ...
    def get_train_loader(self, **kwargs):
        ...
        logger1.debug(f'** in function: DataInterface:get_train_loader')
        raise NotImplementedError

    def get_valid_loader(self, **kwargs):
        """Output of this method will be provided to tasks without optimizer in contract."""
        logger1.debug(f'** in function: DataInterface:get_valid_loader')
        raise NotImplementedError

    def get_train_data_size(self):
        """Information for aggregation."""
        logger1.debug(f'** in function: DataInterface:get_train_data_size')
        raise NotImplementedError

    def get_valid_data_size(self):
        """Information for aggregation."""
        logger1.debug(f'** in function: DataInterface:get_valid_data_size')
        raise NotImplementedError
