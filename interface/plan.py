...
def plan(context):
    ...
    logger.debug(f'** in function: plan')
...
def initialize(context, plan_config, cols_config, data_config,
    ...
    Create a protocol buffer file of the initial model weights for
     the federation.
    """
    logger.debug(f'** in function: initialize')
...
def freeze_plan(plan_config):
    ...
    logger.debug(f'** in function: freeze_plan')
    from pathlib import Path
...
def freeze(plan_config):
    ...
    """
    logger.debug(f'** in function: freeze')
...
def switch_plan(name):
    ...
    logger.debug(f'** in function: switch_plan')
...
def switch_(name):
    ...
    logger.debug(f'** in function: switch_')
    switch_plan(name)
...
def save_(name):
    ...
    logger.debug(f'** in function: save_')
...
def remove_(name):
    """Remove this plan."""
    logger.debug(f'** in function: remove_')
...
def print_():
    ...
    logger.debug(f'** in function: print_')
