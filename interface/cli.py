...
def setup_logging(level='info', log_file=None):
    ...
    logger.debug(f'** in function: setup_logging')
    import logging
...
def disable_warnings():
    ...
    logger.debug(f'** in function: disable_warnings')
    import os
...
class CLI(Group):
    ...
    def __init__(self, name=None, commands=None, **kwargs):
        ...
        logger.debug(f'** in function: CLI:__init__')
        self.commands = commands or {}

    def list_commands(self, ctx):
        """Display all available commands."""
        logger.debug(f'** in function: CLI:list_commands')
        return self.commands

    def format_help(self, ctx, formatter):
        """Dislpay user-friendly help."""
        logger.debug(f'** in function: CLI:format_help')
        show_header()
        uses = [
            f'{ctx.command_path}',
            '[options]',
...
def cli(context, log_level):
    ...
    logger.debug(f'** in function: cli')
    import os
...
def end(context, result, **kwargs):
    ...
    logger.debug(f'** in function: end')
    if context.obj['fail']:
        echo('\n ❌ :(')
    else:
        echo('\n ✔️ OK')
...
def help_(context, subcommand):
    """Display help."""
    logger.debug(f'** in function: help_')
    pass


def error_handler(error):
    """Handle the error."""
    logger.debug(f'** in function: error_handler')
...
def show_header():
    """Show header."""
    logger.debug(f'** in function: show_header')
...
def entry():
    ...
    logger.debug(f'** in function: entry')
...
if __name__ == '__main__':
    logger.debug(f'** in function: cli:__main__')
    entry()
