...
class TensorFlowDataLoader(DataLoader):
    ...
    def __init__(self, batch_size, **kwargs):
        ...
        Returns:
            None
        """
        logger.debug(f'** in function: TensorFlowDataLoader:__init__')
    ...
    def get_feature_shape(self):
        ...
        """
        logger.debug(f'** in function: TensorFlowDataLoader:get_feature_shape')
    ...
    def get_train_loader(self, batch_size=None):
        ...
        loader object
        """
        logger.debug(f'** in function: TensorFlowDataLoader:get_train_loader')
    ...
    def get_valid_loader(self, batch_size=None):
        ...
        Returns:
            loader object
        """
        logger.debug(f'** in function: TensorFlowDataLoader:get_valid_loader')
    ...
    def get_train_data_size(self):
        ...
        """
        logger.debug(f'** in function: TensorFlowDataLoader:get_train_data_size')
    ...
    def get_valid_data_size(self):
        ...
        """
        logger.debug(f'** in function: TensorFlowDataLoader:get_valid_data_size')
    ...
    def _batch_generator(X, y, idxs, batch_size, num_batches):
        ...
        """
        logger.debug(f'** in function: TensorFlowDataLoader:_batch_generator')
    ...
    def _get_batch_generator(self, X, y, batch_size):
        ...
        """
        logger.debug(f'** in function: TensorFlowDataLoader:_get_batch_generator')
