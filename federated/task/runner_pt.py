...
class PyTorchTaskRunner(nn.Module, TaskRunner):
    ...
    def __init__(
        ...
        self.logger.debug(f'** in function: PyTorchTaskRunner:__init__')
        if device:
            self.device = device
        else:
    ...
    def rebuild_model(self, round_num, input_tensor_dict, validation=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:rebuild_model')
    ...
    def validate(self, col_name, round_num, input_tensor_dict,
        ...
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:validate')
    ...
    def train_batches(self, col_name, round_num, input_tensor_dict,
        ...
        Returns:
            ...
            local_output_dict:   Tensors to maintain in the local TensorDB
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:train_batches')
    ...
    def get_tensor_dict(self, with_opt_vars=False):
        ...
        self.logger.debug(f'** in function: PyTorchTaskRunner:get_tensor_dict')
    ...
    def _get_weights_names(self, with_opt_vars=False):
        ...
        self.logger.debug(f'** in function: PyTorchTaskRunner:_get_weights_names')
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars=False):
        ...
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:set_tensor_dict')
    ...
    def get_optimizer(self):
        ...
        self.logger.debug(f'** in function: PyTorchTaskRunner:get_optimizer')
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        Returns:
            list : [TensorKey]
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:get_required_tensorkeys_for_function')
    ...
    def initialize_tensorkeys_for_functions(self, with_opt_vars=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:initialize_tensorkeys_for_functions')
    ...
    def load_native(self, filepath, model_state_dict_key='model_state_dict',
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:load_native')
    ...
    def save_native(self, filepath, model_state_dict_key='model_state_dict',
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:save_native')
        pickle_dict = {
    ...
    def reset_opt_vars(self):
        ...
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:reset_opt_vars')
        pass
    ...
    def train_epoch(self, batch_generator: Iterator[Tuple[np.ndarray, np.ndarray]]) -> Metric:
        ...
        """
        self.logger.debug(f'** in function: PyTorchTaskRunner:train_epoch')
        losses = []
