...
class FeTSChallengeTaskRunner(TaskRunner):
    ...
    def __init__(
        ...
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:__init__')
    ...
    def rebuild_model(self, round_num, input_tensor_dict, validation=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:rebuild_model')
    ...
    def validate(self, col_name, round_num, input_tensor_dict,
        ...
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:validate')
    ...
    def train(self, col_name, round_num, input_tensor_dict, use_tqdm=False, epochs=1, **kwargs):
        ...
        Returns:
            ...
            local_output_dict       : Tensors to maintain in the local TensorDB
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:train')
    ...
    def get_tensor_dict(self, with_opt_vars=False):
        ...
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:get_tensor_dict')
    ...
    def _get_weights_names(self, with_opt_vars=False):
        ...
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:_get_weights_names')
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars=False):
        ...
        Args:
            ...
            with_opt_vars (bool): Return the tensor dictionary including the
                                  optimizer tensors (Default=False)
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:set_tensor_dict')
        set_pt_model_from_tensor_dict(self.model, tensor_dict, self.device, with_opt_vars)

    def get_optimizer(self):
        """Get the optimizer of this instance."""
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:get_optimizer')
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        Returns:
            list : [TensorKey]
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:get_required_tensorkeys_for_function')
    ...
    def initialize_tensorkeys_for_functions(self, with_opt_vars=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:initialize_tensorkeys_for_functions')
    ...
    def load_native(self, filepath, model_state_dict_key='model_state_dict',
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:load_native')
    ...
    def save_native(self, filepath, model_state_dict_key='model_state_dict',
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:save_native')
        pickle_dict = {
    ...
    def reset_opt_vars(self):
        ...
        """
        self.logger.debug(f'** in function: FeTSChallengeTaskRunner:reset_opt_vars')
        pass


def create_tensorkey_dicts(tensor_dict, metric_dict, col_name, round_num, logger, tensor_dict_split_fn_kwargs):
    logger1.debug(f'** in function: create_tensorkey_dicts')
    origin = col_name
    tags = ('trained',)
    output_metric_dict = {}
...
def set_pt_model_from_tensor_dict(model, tensor_dict, device, with_opt_vars=False):
    ...
    Args:
        ...
        with_opt_vars (bool): Return the tensor dictionary including the
                                optimizer tensors (Default=False)
    """
    logger1.debug(f'** in function: set_pt_model_from_tensor_dict')
...
def _derive_opt_state_dict(opt_state_dict):
    ...
    """
    logger1.debug(f'** in function: _derive_opt_state_dict')
...
def expand_derived_opt_state_dict(derived_opt_state_dict, device):
    ...
    """
    logger1.debug(f'** in function: expand_derived_opt_state_dict')
...
def _get_optimizer_state(optimizer):
    ...
    Args:
        optimizer
    """
    logger1.debug(f'** in function: _get_optimizer_state')
...
def _set_optimizer_state(optimizer, device, derived_opt_state_dict):
    ...
    Args:
        ...
        derived_opt_state_dict:
    """
    logger1.debug(f'** in function: _set_optimizer_state')
...
def to_cpu_numpy(state):
    ...
    Args:
        state
    """
    logger1.debug(f'** in function: to_cpu_numpy')
