...
class CoreTaskRunner:
    ...
    def _prepare_tensorkeys_for_agggregation(self, metric_dict, validation_flag,
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:_prepare_tensorkeys_for_agggregation')
    ...
    def adapt_tasks(self):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:adapt_tasks')

        def task_binder(task_name, callable_task):
            self.logger.debug(f'** in function: CoreTaskRunner:task_binder')

            def collaborator_adapted_task(col_name, round_num, input_tensor_dict, **kwargs):
                self.logger.debug(f'** in function: CoreTaskRunner:collaborator_adapted_task')
    ...
    def __init__(self, **kwargs):
        ...
        self.logger.debug(f'** in function: CoreTaskRunner:__init__')
    ...
    def set_task_provider(self, task_provider):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:set_task_provider')
    ...
    def set_data_loader(self, data_loader):
        ...
        self.logger.debug(f'** in function: CoreTaskRunner:set_data_loader')
        self.data_loader = data_loader

    def set_model_provider(self, model_provider):
        """Retrieve a model and an optimizer from the interface object."""
        self.logger.debug(f'** in function: CoreTaskRunner:set_model_provider')
    ...
    def set_framework_adapter(self, framework_adapter):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:set_framework_adapter')
    ...
    def set_logger(self):
        ...
        self.logger.debug(f'** in function: CoreTaskRunner:set_logger')
    ...
    def set_optimizer_treatment(self, opt_treatment):
        ...
        self.logger.debug(f'** in function: CoreTaskRunner:set_optimizer_treatment')
    ...
    def rebuild_model(self, input_tensor_dict, validation=False, device='cpu'):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: CoreTaskRunner:rebuild_model')
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        List
            [TensorKey]
        """
        self.logger.debug(f'** in function: CoreTaskRunner:get_required_tensorkeys_for_function')
    ...
    def initialize_tensorkeys_for_functions(self, with_opt_vars=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: CoreTaskRunner:initialize_tensorkeys_for_functions')
    ...
    def reset_opt_vars(self):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:reset_opt_vars')
        self.optimizer = self.model_provider.provide_optimizer()
    ...
    def get_train_data_size(self):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:get_train_data_size')
    ...
    def get_valid_data_size(self):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:get_valid_data_size')
    ...
    def get_tensor_dict(self, with_opt_vars=False):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:get_tensor_dict')
        args = [self.model]
        if with_opt_vars:
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars=False, device='cpu'):
        ...
        """
        self.logger.debug(f'** in function: CoreTaskRunner:set_tensor_dict')
