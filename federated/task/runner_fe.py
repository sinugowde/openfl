...
class FastEstimatorTaskRunner(TaskRunner):
    ...
    def __init__(self, estimator, **kwargs):
        ...
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:__init__')
        import fastestimator as fe

        class ProgressLoader(fe.trace.Trace):
            def __init__(self, get_progress) -> None:
                super().__init__(mode='train')
                self.logger.debug(f'** in function: ProgressLoader:__init__')
    ...
    def train(self, col_name, round_num, input_tensor_dict, epochs, **kwargs):
        ...
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:train')
    ...
    def validate(self, col_name, round_num, input_tensor_dict, **kwargs):
        ...
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:validate')
    ...
    def initialize_tensorkeys_for_functions(self, with_opt_vars=False):
        ...
        None
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:initialize_tensorkeys_for_functions')
        self.runner.initialize_tensorkeys_for_functions(with_opt_vars)

    def build_model(self):
        """Abstract method."""
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:build_model')
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:get_required_tensorkeys_for_function')
    ...
    def get_tensor_dict(self, with_opt_vars):
        ...
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:get_tensor_dict')
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:set_tensor_dict')
        return self.runner.set_tensor_dict(tensor_dict, with_opt_vars)

    def reset_opt_vars(self):
        """Reinitialize the optimizer variables."""
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:reset_opt_vars')
    ...
    def initialize_globals(self):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:initialize_globals')
    ...
    def load_native(self, filepath, **kwargs):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:load_native')
    ...
    def save_native(self, filepath, **kwargs):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:save_native')
    ...
    def rebuild_model(self, round_num, input_tensor_dict, validation=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:rebuild_model')
    ...
    def set_optimizer_treatment(self, opt_treatment):
        ...
        self.logger.debug(f'** in function: FastEstimatorTaskRunner:set_optimizer_treatment')
