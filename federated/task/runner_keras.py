...
class KerasTaskRunner(TaskRunner):
    ...
    def __init__(self, **kwargs):
        ...
        self.logger.debug(f'** in function: KerasTaskRunner:__init__')
    ...
    def rebuild_model(self, round_num, input_tensor_dict, validation=False):
        ...
        None
        """
        self.logger.debug(f'** in function: KerasTaskRunner:rebuild_model')
    ...
    def train(self, col_name, round_num, input_tensor_dict,
        ...
        dict
            'TensorKey: nparray'
        """
        self.logger.debug(f'** in function: KerasTaskRunner:train')
        if metrics is None:
    ...
    def train_iteration(self, batch_generator, metrics: list = None, **kwargs):
        ...
        """
        self.logger.debug(f'** in function: KerasTaskRunner:train_iteration')
        if metrics is None:
            metrics = []
    ...
    def validate(self, col_name, round_num, input_tensor_dict, **kwargs):
        ...
        """
        self.logger.debug(f'** in function: KerasTaskRunner:validate')
    ...
    def save_native(self, filepath):
        """Save model."""
        self.logger.debug(f'** in function: KerasTaskRunner:save_native')
        self.model.save(filepath)

    def load_native(self, filepath):
        """Load model."""
        self.logger.debug(f'** in function: KerasTaskRunner:load_native')
    ...
    def _get_weights_names(obj):
        ...
        """
        logger1.debug(f'** in function: KerasTaskRunner:_get_weights_names')
    ...
    def _get_weights_dict(obj, suffix=''):
        ...
        """
        logger1.debug(f'** in function: KerasTaskRunner:_get_weights_dict')
        weights_dict = {}
        weight_names = [weight.name for weight in obj.weights]
    ...
    def _set_weights_dict(obj, weights_dict):
        ...
        Returns:
            None
        """
        logger1.debug(f'** in function: KerasTaskRunner:_set_weights_dict')
        weight_names = [weight.name for weight in obj.weights]
    ...
    def get_tensor_dict(self, with_opt_vars, suffix=''):
        ...
        """
        self.logger.debug(f'** in function: KerasTaskRunner:get_tensor_dict')
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars):
        ...
        """
        self.logger.debug(f'** in function: KerasTaskRunner:set_tensor_dict')
    ...
    def reset_opt_vars(self):
        ...
        """
        self.logger.debug(f'** in function: KerasTaskRunner:reset_opt_vars')
    ...
    def set_required_tensorkeys_for_function(self, func_name,
        ...
        **kwargs: Any function arguments {}
        ...
        None
        """
        self.logger.debug(f'** in function: KerasTaskRunner:set_required_tensorkeys_for_function')
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        List
            [TensorKey]
        """
        self.logger.debug(f'** in function: KerasTaskRunner:get_required_tensorkeys_for_function')
        if func_name == 'validate':
    ...
    def update_tensorkeys_for_functions(self):
        ...
        None
        """
        self.logger.debug(f'** in function: KerasTaskRunner:update_tensorkeys_for_functions')
    ...
    def initialize_tensorkeys_for_functions(self, with_opt_vars=False):
        ...
        None
        """
        self.logger.debug(f'** in function: KerasTaskRunner:initialize_tensorkeys_for_functions')
        # TODO there should be a way to programmatically iterate through all
        #  of the methods in the class and declare the tensors.
        # For now this is done manually
