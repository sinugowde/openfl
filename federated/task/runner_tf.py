...
class TensorFlowTaskRunner(TaskRunner):
    ...
    def __init__(self, **kwargs):
        ...
        self.logger.debug(f'** in function: TensorFlowTaskRunner:__init__')
    ...
    def rebuild_model(self, round_num, input_tensor_dict, validation=False):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:rebuild_model')
    ...
    def train_batches(self, col_name, round_num, input_tensor_dict,
        ...
        Returns:
            float: loss metric
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:train_batches')
    ...
    def train_batch(self, X, y):
        ...
        Returns:
            float: loss metric
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:train_batch')
    ...
    def validate(self, col_name, round_num,
        ...
        Returns:
            dict: {<metric>: <value>}
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:validate')
        batch_size = self.data_loader.batch_size
    ...
    def validate_batch(self, X, y):
        ...
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:validate_batch')
        feed_dict = {self.X: X, self.y: y}
    ...
    def get_tensor_dict(self, with_opt_vars=True):
        ...
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:get_tensor_dict')
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:set_tensor_dict')
        if with_opt_vars:
    ...
    def reset_opt_vars(self):
        ...
        self.logger.debug(f'** in function: TensorFlowTaskRunner:reset_opt_vars')
    ...
    def initialize_globals(self):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:initialize_globals')
    ...
    def _get_weights_names(self, with_opt_vars=True):
        ...
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:_get_weights_names')
        if with_opt_vars is True:
            variables = self.fl_vars
        else:
            variables = self.tvars
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        Returns:
            list : [TensorKey]
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:get_required_tensorkeys_for_function')
    ...
    def initialize_tensorkeys_for_functions(self, with_opt_vars=False):
        ...
        """
        self.logger.debug(f'** in function: TensorFlowTaskRunner:initialize_tensorkeys_for_functions')
...
def tf_set_tensor_dict(tensor_dict, session, variables,
    ...
    """
    logger1.debug(f'** in function: tf_set_tensor_dict')
