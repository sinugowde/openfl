...
class FederatedModel(TaskRunner):
    ...
    def __init__(self, build_model, optimizer=None, loss_fn=None, **kwargs):
        ...
        """
        logger.debug(f'** in function: FederatedModel:__init__')
    ...
    def __getattribute__(self, attr):
        ...
        logger.debug(f'** in function: FederatedModel:__getattribute__')
    ...
    def setup(self, num_collaborators, **kwargs):
        ...
        Returns:
            List of models
        """
        logger.debug(f'** in function: FederatedModel:setup')
        return [
            FederatedModel(
                self.build_model,
