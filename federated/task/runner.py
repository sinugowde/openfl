...
class TaskRunner:
    ...
    def __init__(self, data_loader, tensor_dict_split_fn_kwargs: dict = None, **kwargs):
        ...
        self.set_logger()
        self.logger.debug(f'** in function: TaskRunner:__init__')

    def set_logger(self):
        """Set up the log object."""
        self.logger = getLogger(__name__)
        self.logger.debug(f'** in function: TaskRunner:set_logger')

    def set_optimizer_treatment(self, opt_treatment):
        """Change the treatment of current instance optimizer."""
        self.logger.debug(f'** in function: TaskRunner:set_optimizer_treatment')
    ...
    def get_data_loader(self):
        ...
        Returns:
            data_loader object
        """
        self.logger.debug(f'** in function: TaskRunner:get_data_loader')
    ...
    def set_data_loader(self, data_loader):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TaskRunner:set_data_loader')
    ...
    def get_train_data_size(self):
        ...
        """
        self.logger.debug(f'** in function: TaskRunner:get_train_data_size')
    ...
    def get_valid_data_size(self):
        ...
        """
        self.logger.debug(f'** in function: TaskRunner:get_valid_data_size')
    ...
    def train_batches(self, num_batches=None, use_tqdm=False):
        ...
        Returns:
            dict: {<metric>: <value>}
        """
        self.logger.debug(f'** in function: TaskRunner:train_batches')
    ...
    def validate(self):
        ...
        Returns:
            dict: {<metric>: <value>}
        """
        self.logger.debug(f'** in function: TaskRunner:validate')
        raise NotImplementedError
    ...
    def get_required_tensorkeys_for_function(self, func_name, **kwargs):
        ...
        """
        self.logger.debug(f'** in function: TaskRunner:get_required_tensorkeys_for_function')
        raise NotImplementedError
    ...
    def get_tensor_dict(self, with_opt_vars):
        ...
        """
        self.logger.debug(f'** in function: TaskRunner:get_tensor_dict')
        raise NotImplementedError
    ...
    def set_tensor_dict(self, tensor_dict, with_opt_vars):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TaskRunner:set_tensor_dict')
        raise NotImplementedError

    def reset_opt_vars(self):
        """Reinitialize the optimizer variables."""
        self.logger.debug(f'** in function: TaskRunner:reset_opt_vars')
        raise NotImplementedError
    ...
    def initialize_globals(self):
        ...
        self.logger.debug(f'** in function: TaskRunner:initialize_globals')
        raise NotImplementedError
    ...
    def load_native(self, filepath, **kwargs):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TaskRunner:load_native')
        raise NotImplementedError
    ...
    def save_native(self, filepath, **kwargs):
        ...
        Returns:
            None
        """
        self.logger.debug(f'** in function: TaskRunner:save_native')
        raise NotImplementedError
