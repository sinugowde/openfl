...
class Aggregator:
    ...
    def __init__(self,
        ...
        self.logger.debug(f'in function: Aggregator:__init__')
    ...
    def _load_initial_tensors(self):
        ...
        Returns:
            None
        """
        self.logger.debug(f'in function: Aggregator:_load_initial_tensors')
    ...
    def _load_initial_tensors_from_dict(self, tensor_dict):
        ...
        Returns:
            None
        """
        self.logger.debug(f'in function: Aggregator:_load_initial_tensors_from_dict')
    ...
    def _save_model(self, round_number, file_path):
        ...
        Returns:
            None
        """
        self.logger.debug(f'in function: Aggregator:_save_model')
    ...
    def valid_collaborator_cn_and_id(self, cert_common_name,
        ...
        """
        self.logger.debug(f'in function: Aggregator:valid_collaborator_cn_and_id')
    ...
    def all_quit_jobs_sent(self):
        ...
        self.logger.debug(f'in function: Aggregator:all_quit_jobs_sent')
    ...
    def _time_to_quit(self):
        ...
        """
        self.logger.debug(f'in function: Aggregator:_time_to_quit')
    ...
    def get_tasks(self, collaborator_name):
        ...
        Returns:
            ...
            time_to_quit: bool
        """
        self.logger.debug(f'in function: Aggregator:get_tasks')
    ...
    def get_aggregated_tensor(self, collaborator_name, tensor_name,
        ...
        """
        self.logger.debug(f'in function: Aggregator:get_aggregated_tensor')
    ...
    def _nparray_to_named_tensor(self, tensor_key, nparray, send_model_deltas,
        ...
        """
        self.logger.debug(f'in function: Aggregator:_nparray_to_named_tensor')
    ...
    def _collaborator_task_completed(self, collaborator, task_name, round_num):
        ...
        Returns:
            task_competed : bool
                ...
                round
        """
        self.logger.debug(f'in function: Aggregator:_collaborator_task_completed')
    ...
    def send_local_task_results(self, collaborator_name, round_number, task_name,
        ...
        Returns:
             None
        """
        self.logger.debug(f'in function: Aggregator:send_local_task_results')
    ...
    def _process_named_tensor(self, named_tensor, collaborator_name):
        ...
        """
        self.logger.debug(f'in function: Aggregator:_process_named_tensor')
    ...
    def _end_of_task_check(self, task_name):
        ...
        Returns:
            complete : boolean
                Is the task done
        """
        self.logger.debug(f'in function: Aggregator:_end_of_task_check')
    ...
    def _prepare_trained(self, tensor_name, origin, round_number, report, agg_results):
        ...
        """
        self.logger.debug(f'in function: Aggregator:_prepare_trained')
    ...
    def _compute_validation_related_task_metrics(self, task_name):
        ...
        """
        self.logger.debug(f'in function: Aggregator:_compute_validation_related_task_metrics')
    ...
    def _end_of_round_check(self):
        ...
        Returns:
            None
        """
        self.logger.debug(f'in function: Aggregator:_end_of_round_check')
    ...
    def _is_task_done(self, task_name):
        ...
        self.logger.debug(f'in function: Aggregator:_is_task_done')
    ...
    def _is_round_done(self):
        ...
        self.logger.debug(f'in function: Aggregator:_is_round_done')
    ...
    def _log_big_warning(self):
        ...
        self.logger.debug(f'in function: Aggregator:_log_big_warning')
    ...
    def stop(self, failed_collaborator: str = None) -> None:
        ...
        self.logger.debug(f'in function: Aggregator:stop')
