...
class Experiment:
    ...
    def __init__(
        ...
        logger.debug(f'** in function: Experiment:__init__')
        self.name = name
    ...
    async def start(
        ...
        """Run experiment."""
        logger.debug(f'** in function: Experiment:start')
    ...
    def _create_aggregator_grpc_server(
        ...
        logger.debug(f'** in function: Experiment:_create_aggregator_grpc_server')
    ...
    async def _run_aggregator_grpc_server(aggregator_grpc_server: AggregatorGRPCServer) -> None:
        """Run aggregator."""
        logger.debug(f'** in function: Experiment:_run_aggregator_grpc_server')
        logger.info('🧿 Starting the Aggregator Service.')
...
class ExperimentsRegistry:
    ...
    def __init__(self) -> None:
        ...
        logger.debug(f'** in function: ExperimentsRegistry:__init__')
    ...
    def active_experiment(self) -> Union[Experiment, None]:
        ...
        logger.debug(f'** in function: ExperimentsRegistry:active_experiment')
    ...
    def pending_experiments(self) -> List[str]:
        ...
        logger.debug(f'** in function: ExperimentsRegistry:pending_experiments')
        return self.__pending_experiments

    def add(self, experiment: Experiment) -> None:
        """Add experiment to queue of not started experiments."""
        logger.debug(f'** in function: ExperimentsRegistry:add')
    ...
    def remove(self, name: str) -> None:
        ...
        logger.debug(f'** in function: ExperimentsRegistry:remove')
    ...
    def __getitem__(self, key: str) -> Experiment:
        ...
        logger.debug(f'** in function: ExperimentsRegistry:__getitem__')
        return self.__dict[key]

    def get(self, key: str, default=None) -> Experiment:
        """Get experiment by name."""
        logger.debug(f'** in function: ExperimentsRegistry:get')
        return self.__dict.get(key, default)

    def get_user_experiments(self, user: str) -> List[Experiment]:
        """Get list of experiments for specific user."""
        logger.debug(f'** in function: ExperimentsRegistry:get_user_experiments')
        return [
            exp
    ...
    def __contains__(self, key: str) -> bool:
        ...
        logger.debug(f'** in function: ExperimentsRegistry:__contains__')
        return key in self.__dict

    def finish_active(self) -> None:
        """Finish active experiment."""
        logger.debug(f'** in function: ExperimentsRegistry:finish_active')
    ...
    async def get_next_experiment(self):
        ...
        """
        logger.debug(f'** in function: ExperimentsRegistry:get_next_experiment')
        while True:
