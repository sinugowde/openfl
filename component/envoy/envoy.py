...
class Envoy:
    ...
    def __init__(
        ...
        logger.debug(f'** in function: Envoy:__init__')
    ...
    def run(self):
        ...
        logger.debug(f'** in function: Envoy:run')
        while True:
            try:
    ...
    def _save_data_stream_to_file(data_stream):
        logger.debug(f'** in function: Envoy:_save_data_stream_to_file')
    ...
    def send_health_check(self):
        ...
        logger.debug(f'** in function: Envoy:send_health_check')
    ...
    def _get_cuda_device_info(self):
        logger.debug(f'** in function: Envoy:_get_cuda_device_info')
    ...
    def _run_collaborator(self, plan='plan/plan.yaml'):
        ...
        logger.debug(f'** in function: Envoy:_run_collaborator')
    ...
    def start(self):
        logger.debug(f'** in function: Envoy:start')
        """Start the envoy."""
        try:
