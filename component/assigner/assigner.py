...
class Assigner:
    ...
    def __init__(self, tasks, authorized_cols,
        ...
        """Initialize."""
        logger.debug(f'** in function: Assigner:__init__')
    ...
    def define_task_assignments(self):
        """Abstract method."""
        logger.debug(f'** in function: Assigner:define_task_assignments')
        raise NotImplementedError

    def get_tasks_for_collaborator(self, collaborator_name, round_number):
        """Abstract method."""
        logger.debug(f'** in function: Assigner:get_tasks_for_collaborator')
        raise NotImplementedError

    def get_collaborators_for_task(self, task_name, round_number):
        """Abstract method."""
        logger.debug(f'** in function: Assigner:get_collaborators_for_task')
        raise NotImplementedError
    ...
    def get_all_tasks_for_round(self, round_number):
        ...
        """
        logger.debug(f'** in function: Assigner:get_all_tasks_for_round')
        return self.all_tasks_in_groups

    def get_aggregation_type_for_task(self, task_name):
        """Extract aggregation type from self.tasks."""
        logger.debug(f'** in function: Assigner:get_aggregation_type_for_task')
