...
class StaticGroupedAssigner(Assigner):
    ...
    def __init__(self, task_groups, **kwargs):
        """Initialize."""
        logger.debug(f'** in function: StaticGroupedAssigner:__init__')
        self.task_groups = task_groups
        super().__init__(**kwargs)

    def define_task_assignments(self):
        """All of the logic to set up the map of tasks to collaborators is done here."""
        logger.debug(f'** in function: StaticGroupedAssigner:define_task_assignments')
        cols_amount = sum([
    ...
    def get_tasks_for_collaborator(self, collaborator_name, round_number):
        ...
        logger.debug(f'** in function: StaticGroupedAssigner:get_tasks_for_collaborator')
    ...
    def get_collaborators_for_task(self, task_name, round_number):
        ...
        logger.debug(f'** in function: StaticGroupedAssigner:get_collaborators_for_task')
