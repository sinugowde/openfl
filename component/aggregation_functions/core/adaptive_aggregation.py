...
class AdaptiveAggregation(AggregationFunction):
    ...
    def __init__(
        ...
        """
        logger.debug(f'in function: AdaptiveAggregation:__init__')
        super().__init__()
    ...
    def _make_gradient(
        ...
        """Make gradient."""
        logger.debug(f'in function: AdaptiveAggregation:_make_gradient')
    ...
    def call(
        ...
        """
        logger.debug(f'in function: AdaptiveAggregation:call')
