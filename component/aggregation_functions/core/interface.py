...
class AggregationFunction(metaclass=SingletonABCMeta):
    ...
    def __init__(self):
        ...
        """
        logger.debug(f'in function: AggregationFunction:__init__')
    ...
    def call(self,
        ...
        """
        logger.debug(f'in function: AggregationFunction:call')
    ...
    def __call__(self, local_tensors,
        ...
        logger.debug(f'in function: AggregationFunction:__call__')
