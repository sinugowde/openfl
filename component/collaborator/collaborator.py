...
class Collaborator:
    ...
    def __init__(self,
        ...
        self.logger.debug(f'** in function: Collaborator:__init__')
    ...
    def set_available_devices(self, cuda: Tuple[str] = ()):
        ...
        """
        self.logger.debug(f'** in function: Collaborator:set_available_devices')
        self.cuda_devices = cuda

    def run(self):
        """Run the collaborator."""
        self.logger.debug(f'** in function: Collaborator:run')
        while True:
    ...
    def run_simulation(self):
        ...
        """
        self.logger.debug(f'** in function: Collaborator:run_simulation')
        while True:
            tasks, round_number, sleep_time, time_to_quit = self.get_tasks()
            if time_to_quit:
                self.logger.info('End of Federation reached. Exiting...')
    ...
    def get_tasks(self):
        ...
        self.logger.debug(f'** in function: Collaborator:get_tasks')
    ...
    def do_task(self, task, round_number):
        ...
        self.logger.debug(f'** in function: Collaborator:do_task')
    ...
    def get_numpy_dict_for_tensorkeys(self, tensor_keys):
        ...
        self.logger.debug(f'** in function: Collaborator:get_numpy_dict_for_tensorkeys')
    ...
    def get_data_for_tensorkey(self, tensor_key):
        ...
        """
        self.logger.debug(f'** in function: Collaborator:get_data_for_tensorkey')
    ...
    def get_aggregated_tensor_from_aggregator(self, tensor_key,
        ...
        nparray     : The decompressed tensor associated with the requested
                      tensor key
        """
        self.logger.debug(f'** in function: Collaborator:get_aggregated_tensor_from_aggregator')
        tensor_name, origin, round_number, report, tags = tensor_key
    ...
    def send_task_results(self, tensor_dict, round_number, task_name):
        ...
        self.logger.debug(f'** in function: Collaborator:send_task_results')
        named_tensors = [
    ...
    def nparray_to_named_tensor(self, tensor_key, nparray):
        ...
        """
        self.logger.debug(f'** in function: Collaborator:nparray_to_named_tensor')
    ...
    def named_tensor_to_nparray(self, named_tensor):
        ...
        self.logger.debug(f'** in function: Collaborator:named_tensor_to_nparray')
