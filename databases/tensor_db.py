...
class TensorDB:
    ...
    def __init__(self) -> None:
        """Initialize."""
        logger.debug(f'** in function: TensorDB:__init__')
    ...
    def _bind_convenience_methods(self):
        logger.debug(f'** in function: TensorDB:_bind_convenience_methods')
    ...
    def __repr__(self) -> str:
        ...
        logger.debug(f'** in function: TensorDB:__repr__')
    ...
    def __str__(self) -> str:
        ...
        logger.debug(f'** in function: TensorDB:__str__')
    ...
    def clean_up(self, remove_older_than: int = 1) -> None:
        ...
        logger.debug(f'** in function: TensorDB:clean_up')
    ...
    def cache_tensor(self, tensor_key_dict: Dict[TensorKey, np.ndarray]) -> None:
        ...
        Returns:
            None
        """
        logger.debug(f'** in function: TensorDB:cache_tensor')
        entries_to_add = []
        with self.mutex:
    ...
    def get_tensor_from_cache(self, tensor_key: TensorKey) -> Optional[np.ndarray]:
        ...
        """
        logger.debug(f'** in function: TensorDB:get_tensor_from_cache')
        tensor_name, origin, fl_round, report, tags = tensor_key
    ...
    def get_aggregated_tensor(self, tensor_key: TensorKey, collaborator_weight_dict: dict,
        ...
        """
        logger.debug(f'** in function: TensorDB:get_aggregated_tensor')
    ...
    def _iterate(self, order_by: str = 'round', ascending: bool = False) -> Iterator[pd.Series]:
        logger.debug(f'** in function: TensorDB:_iterate')
