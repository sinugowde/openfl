...
class FedProxOptimizer(keras.optimizers.Optimizer):
    ...
    def _prepare(self, var_list):
        logger.debug(f'** in function: FedProxOptimizer:_prepare')
    ...
    def _create_slots(self, var_list):
        logger.debug(f'** in function: FedProxOptimizer:_create_slots')
        for v in var_list:
            self.add_slot(v, 'vstar')

    def _resource_apply_dense(self, grad, var):
        logger.debug(f'** in function: FedProxOptimizer:_resource_apply_dense')
    ...
    def _apply_sparse_shared(self, grad, var, indices, scatter_add):
        logger.debug(f'** in function: FedProxOptimizer:_apply_sparse_shared')
        lr_t = tf.cast(self._lr_t, var.dtype.base_dtype)
        mu_t = tf.cast(self._mu_t, var.dtype.base_dtype)
        vstar = self.get_slot(var, 'vstar')
    ...
    def _resource_apply_sparse(self, grad, var):
        logger.debug(f'** in function: FedProxOptimizer:_resource_apply_sparse')
    ...
    def get_config(self):
        ...
        Returns:
            Python dictionary.
        """
        logger.debug(f'** in function: FedProxOptimizer:get_config')
