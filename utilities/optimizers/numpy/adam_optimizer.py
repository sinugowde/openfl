...
class NumPyAdam(Optimizer):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__()
        logger.debug(f'** in function: NumPyAdam:__init__')
    ...
    def _update_first_moment(self, grad_name: str, grad: np.ndarray) -> None:
        ...
        logger.debug(f'** in function: NumPyAdam:_update_first_moment')
    ...
    def _update_second_moment(self, grad_name: str, grad: np.ndarray) -> None:
        ...
        logger.debug(f'** in function: NumPyAdam:_update_second_moment')
    ...
    def step(self, gradients: Dict[str, np.ndarray]) -> None:
        ...
        """
        logger.debug(f'** in function: NumPyAdam:step')
