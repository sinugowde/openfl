...
class ExperimentWorkspace:
    ...
    def __init__(
        ...
        logger.debug(f'** in function: ExperimentWorkspace:__init__')
    ...
    def _install_requirements(self):
        ...
        logger.debug(f'** in function: ExperimentWorkspace:_install_requirements')
    ...
    def __enter__(self):
        ...
        logger.debug(f'** in function: ExperimentWorkspace:__enter__')
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        logger.debug(f'** in function: ExperimentWorkspace:__exit__')
        os.chdir(self.cwd)
...
def dump_requirements_file(
    ...
    logger.debug(f'** in function: ExperimentWorkspace:dump_requirements_file')
...
def _is_package_versioned(package: str) -> bool:
    ...
    logger.debug(f'** in function: ExperimentWorkspace:_is_package_versioned')
    return ('==' in package
