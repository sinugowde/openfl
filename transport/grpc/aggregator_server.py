...
class AggregatorGRPCServer(aggregator_pb2_grpc.AggregatorServicer):
    ...
    def __init__(self,
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:__init__')
    ...
    def validate_collaborator(self, request, context):
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:validate_collaborator')
        if self.tls:
    ...
    def get_header(self, collaborator_name):
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:get_header')
    ...
    def check_request(self, request):
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:check_request')
    ...
    def GetTasks(self, request, context):  # NOQA:N802
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:GetTasks')
    ...
    def GetAggregatedTensor(self, request, context):  # NOQA:N802
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:GetAggregatedTensor')
        self.validate_collaborator(request, context)
        self.check_request(request)
        collaborator_name = request.header.sender
    ...
    def SendLocalTaskResults(self, request, context):  # NOQA:N802
        ...
        """
        logger.debug(f'** in function: AggregatorGRPCServer:SendLocalTaskResults')
    ...
    def get_server(self):
        """Return gRPC server."""
        logger.debug(f'** in function: AggregatorGRPCServer:get_server')
    ...
    def serve(self):
        ...
        logger.debug(f'** in function: AggregatorGRPCServer:serve')
        self.get_server()
