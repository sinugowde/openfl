...
class DirectorGRPCServer(director_pb2_grpc.DirectorServicer):
    ...
    def __init__(
        ...
        logger.debug(f'** in function: DirectorGRPCServer:__init__')
    ...
    def _fill_certs(self, root_certificate, private_key, certificate):
        """Fill certificates."""
        logger.debug(f'** in function: DirectorGRPCServer:_fill_certs')
        if self.tls:
    ...
    def get_caller(self, context):
        ...
        """
        logger.debug(f'** in function: DirectorGRPCServer:get_caller')
        if self.tls:
    ...
    def start(self):
        ...
        logger.debug(f'** in function: DirectorGRPCServer:start')
    ...
    async def _run_server(self):
        logger.debug(f'** in function: DirectorGRPCServer:_run_server')
    ...
    async def UpdateShardInfo(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:UpdateShardInfo')
    ...
    async def SetNewExperiment(self, stream, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:SetNewExperiment')
    ...
    async def GetTrainedModel(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetTrainedModel')
    ...
    async def GetExperimentData(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetExperimentData')
    ...
    async def WaitExperiment(self, request_iterator, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:WaitExperiment')
    ...
    async def GetDatasetInfo(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetDatasetInfo')
    ...
    async def GetMetricStream(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetMetricStream')
    ...
    async def RemoveExperimentData(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:RemoveExperimentData')
    ...
    async def SetExperimentFailed(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:SetExperimentFailed')
    ...
    async def UpdateEnvoyStatus(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:UpdateEnvoyStatus')
    ...
    async def GetEnvoys(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetEnvoys')
    ...
    async def GetExperimentsList(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetExperimentsList')
        caller = self.get_caller(context)
    ...
    async def GetExperimentDescription(self, request, context):  # NOQA:N802
        ...
        logger.debug(f'** in function: DirectorGRPCServer:GetExperimentDescription')
        caller = self.get_caller(context)
