...
class ConstantBackoff:
    ...
    def __init__(self, reconnect_interval, logger, uri):
        ...
        logger.debug(f'** in function: ConstantBackoff:__init__')
    ...
    def sleep(self):
        ...
        logger.debug(f'** in function: ConstantBackoff:sleep')
...
class RetryOnRpcErrorClientInterceptor(
    ...
    def __init__(
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:__init__')
        self.sleeping_policy = sleeping_policy
        self.status_for_retry = status_for_retry

    def _intercept_call(self, continuation, client_call_details, request_or_iterator):
        """Intercept the call to the gRPC server."""
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:_intercept_call')
...
def _atomic_connection(func):
    logger.debug(f'** in function: _atomic_connection')
    def wrapper(self, *args, **kwargs):
        logger.debug(f'** in function: wrapper')
        self.reconnect()
...
class AggregatorGRPCClient:
    ...
    def create_insecure_channel(self, uri):
        ...
        """
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:create_insecure_channel')
    ...
    def create_tls_channel(self, uri, root_certificate, disable_client_auth,
        ...
        Returns:
            An insecure gRPC channel object
        """
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:create_tls_channel')
    ...
    def _set_header(self, collaborator_name):
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:_set_header')
    ...
    def validate_response(self, reply, collaborator_name):
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:validate_response')
    ...
    def disconnect(self):
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:disconnect')
        self.logger.debug(f'Disconnecting from gRPC server at {self.uri}')
        self.channel.close()

    def reconnect(self):
        """Create a new channel with the gRPC server."""
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:reconnect')
    ...
    def get_tasks(self, collaborator_name):
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:get_tasks')
    ...
    def get_aggregated_tensor(self, collaborator_name, tensor_name, round_number,
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:get_aggregated_tensor')
        self._set_header(collaborator_name)
    ...
    def send_local_task_results(self, collaborator_name, round_number,
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:send_local_task_results')
        self._set_header(collaborator_name)
    ...
    def _get_trained_model(self, experiment_name, model_type):
        ...
        logger.debug(f'** in function: RetryOnRpcErrorClientInterceptor:_get_trained_model')
